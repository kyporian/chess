...
//MOVE METHODS
    ...
    public static void placePiece(String square, String[] pieceData) {
        ...
        Validator.validMove(position, pieceData); //Validates move
        
        //Move all this into if statement with validMove condition
        String piece = pieceData[2];
        Chess.board[r][c] = piece; //
        Chess.board[Integer.parseInt(pieceData[0])][Integer.parseInt(pieceData[1])] = "."; //Replaces old location with an empty tile
    }
}
